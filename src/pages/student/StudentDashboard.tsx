...
const StudentDashboard = () => {
  ...
  const upcomingDrives = upcomingDrivesData || [];
  ...
  const profileCompletion = 60; // Mock value - could be calculated from profile completeness
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-3 text-sm text-muted-foreground">
                          ...
                          <span className="font-semibold text-primary">
                            ${drive.salary.min}k - ${drive.salary.max}k
                          </span>
                        </div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 ml-4">
                      {drive.requirements.slice(0, 2).map((req, idx) => (
